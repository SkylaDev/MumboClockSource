...
class Ui_Dialog(object):
    def __init__(self, dialog):
        ...
        self.about03.setText(self._translate("Dialog", "Developed by: SkylaDev"))
        ...
        self.links05.setText(self._translate("Dialog", "- <a href=\"https://github.com/SkylaDev/Mumbo-clock\">Mumbo clock GitHub repository</a>"))
